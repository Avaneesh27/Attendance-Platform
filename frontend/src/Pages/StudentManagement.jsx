...
export default function StudentManagement() {
  ...
  const studentOperations = [
    {
      title: "View & Search Students",
      description: "View and search all registered students",
      icon: "👥",
      path: "/students",
    ...
    },
    {
      ...
      description: "View and manage inactive students",
      icon: "🚫",
    ...
    },
    {
      ...
      description: "Permanently delete a student",
      icon: "🗑️",
      path: "/delete-student",
    ...
    <div className="min-h-screen bg-gray-100 overflow-x-hidden">
      ...
      <div className="p-1.5 sm:p-3 md:p-6 ml-0 md:ml-56 mt-16 md:mt-0 pb-8 md:pb-12 box-border">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-2 sm:mb-3 md:mb-4 lg:mb-6 gap-2 sm:gap-0">
          <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold">Student Management</h1>
          <button
            onClick={() => navigate("/")}
